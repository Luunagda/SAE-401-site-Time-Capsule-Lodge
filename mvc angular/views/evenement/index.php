<section>
  <form class="form-filtre" action="/evenement/filtre" method="POST">
      <fieldset>
    ...
    <main class="d-flex grid gap-5 flex-wrap justify-content-around catalogue" style="margin: 2%;">
        <div class="titre-catalogue">
            <h1 class='titre-page'>Chambre proposant un évènement</h1>
            <nav aria-label="breadcrumb" class="fil_arianne">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/Main" class="lien">Accueil</a></li>
                    <li class="breadcrumb-item" aria-current="page"><a href="/evenement" class="lien" style="color: black;"><strong>Évènement</strong></a></li>
                </ol>
            </nav>
        </div>
  <?php 
  ...
  foreach($articles as $article){ ?>
          <div class="card " style="width: 25rem;" >
              ...
              <div class="card-body">
                  ...
                  <div class="btn-card">
                    <a href="/evenement/lire/<?=$article['slug'] ?>" class="btn btn-lg btn-dark ms-3 voirplus" data-id="<?=$article['id'] ?>">Voir +</a>
