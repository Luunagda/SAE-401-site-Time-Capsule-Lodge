...
console.log(data)
  document.addEventListener('DOMContentLoaded', () => {
    ...
    data.products.forEach(product => {
      ...
      console.log(product.date_aller)
      ...
      <label for="date-arrivee">Du: </label>
      <input type="date" class="form-control" id="date-arrivee" value="${product.date_aller}">
    </div>
    <div class="form-group">
      <label for="date-depart">Au: </label>
      <input type="date" class="form-control" id="date-depart" value="${product.date_retour}">
    </div>
      </td>
    ...
    btns_suppr.forEach(btn => {
      btn.addEventListener('click', (e) => {
          ...
          console.log(row.querySelector('td:nth-child(2)').innerText);
          
          const totalPrixProduit = row.querySelector('td:nth-child(2)').innerText;
          //console.log(row);
          const totalPrixSansDevise = totalPrixProduit.replace(' XPF','').replace(',','.');
          console.log(totalPrixSansDevise)
